      ...
      <div className="grid grid-cols-4 gap-4 mt-12">
        {
            data.results.map(
                (blog)=>{
                    return <Link passHref={true}  href={'/blogs/'+blog.properties.slug?.rich_text[0]?.plain_text} key={blog.id} ><div className="bg-white rounded-lg shadow-md hover:shadow-2xl aspect-[16/12] relative overflow-hidden cursor-pointer">
