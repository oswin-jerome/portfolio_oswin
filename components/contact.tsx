...
const Contact = () => {
  ...
  return (
    <div id="contact" className="container mx-auto relative pt-28  ">
      ...
      <h2 data-animate-on-scroll className="text-2xl lg:text-5xl font-bold text-gray-700 z-10 -mt-4 lg:mt-12 lg:w-2/4 dark:text-white">
        Share your Queries & Feedback.
      </h2>

      <div className="grid grid-cols-2  mt-8 lg:mt-28">
        <div data-animate-on-scroll className="col-span-2 lg:col-span-1 mt-10">
        ...
        <div className=" col-span-2 lg:col-span-1 lg:pl-44 pt-32 lg:pt-0 relative">
          <h4 data-animate-on-scroll className="font-bold mb-10 lg:mb-20 text-3xl text-accent">
            Other ways to contact
          </h4>
          <Image data-animate-on-scroll className="absolute rotate-90 top-0 left-[20%] lg:rotate-0 lg:left-10 lg:top-[50%]" src="/arrow.svg" alt="arrow" width={100} height={50} />

          <div className="grid grid-cols-2 lg:flex lg:flex-col lg:justify-center gap-8 ">
            {links.map((skill, i) => (
              <a data-animate-on-scroll href={skill.url} key={i} target="_blank" rel="noopener noreferrer">
