...
const About = () => {
  return (
    <div id="about" className="container mx-auto relative pt-28  mb-24 lg:mb-60">
      ...
      <h1 data-animate-on-scroll className="text-2xl lg:text-5xl font-bold text-gray-700 dark:text-white z-10 -mt-3 lg:mt-20">
        Hi, I’m <span className="text-accent">Oswin Jerome</span>. Nice to meet you.
      </h1>
      <p data-animate-on-scroll className="text-gray-600 dark:text-white dark:opacity-75 text-sm lg:w-[80%]">
