...
const NavBar = () => {
  ...
  return (
    <div className="container mx-auto py-4 flex justify-between px-4 md:px-0 flex-row-reverse md:flex-row items-center h-[8vh]">
      ...
      {
        <div className={(isOpen ? "translate-x-0 transition-all" : "-translate-x-full transition-all") + "  fixed top-0 bottom-0 z-50 left-0 w-[75vw]" + " bg-dark-background shadow-2xl "}>
