...
const Feedback = () => {
  ...
  return (
    <div className="container mx-auto relative pt-28  px-4 lg:px-0">
      ...
      <p className="text-2xl lg:text-5xl font-bold text-gray-700 z-10 -mt-4 lg:mt-12 lg:w-2/4 dark:text-white dark:opacity-75">Look what clients & people I have worked with have to tell.</p>
