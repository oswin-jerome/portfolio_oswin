...
const RecentWorks = ({posts} :any) => {
  ...
  return (
    <div className="container mx-auto relative pt-28  px-4 lg:px-0">
      ...
      <h1 className="text-2xl lg:text-5xl font-bold text-gray-700 z-10 -mt-6 lg:mt-0 lg:w-2/4 dark:text-white ">Here are a few design projects I have worked on recently.</h1>
